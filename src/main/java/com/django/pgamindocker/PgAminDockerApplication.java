package com.django.pgamindocker;

import com.django.pgamindocker.event.Event;
import com.django.pgamindocker.event.EventRepository;
...
public class PgAminDockerApplication {

    private static final Logger log = LoggerFactory.getLogger(PgAminDockerApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(PgAminDockerApplication.class, args);
    }
